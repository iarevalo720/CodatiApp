...
namespace Core.Interfaces
{
    public interface IUserRepository
    {
        ...
        public Task<IdentityResult> CrearUsuario(ApplicationUser applicationUser, string password);
        public Task AsignarRol(ApplicationUser user, string roleName);
        public Task EliminarRolUsuario(ApplicationUser user, string roleName);
